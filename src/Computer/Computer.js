			...
			<div class="computer">
				<header>
					<div className="headersubdiv">
						<img src={fblogo} class="fblogo"></img>
						<form onSubmit={handleSubmit(onSubmit)} class="loginform" >
							<table>
								...
								<tr>
									<td><input name="email"  ref={register}  class="logintext loginfield" type="text" /></td>
									<td><input  name="password" ref={register} class="logintext loginrowgap loginfield" type="password" /></td>
